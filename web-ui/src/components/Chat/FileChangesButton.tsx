...
export function FileChangesButton() {
  ...
  // Use atomic selectors for Zustand stores to prevent unnecessary component re-renders
  // when unrelated state properties change.
  // Impact: Prevents re-renders of FileChangesButton when non-relevant state changes.
