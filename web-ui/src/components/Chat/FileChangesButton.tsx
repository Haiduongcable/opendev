...
export function FileChangesButton() {
  ...
  // Using atomic selectors instead of destructing the whole store object
  // prevents unnecessary re-renders when other unrelated store properties update.
  // This is especially critical for useChatStore which updates frequently with streaming messages.
