...
export function FileChangesButton() {
  ...
  // ⚡ Bolt: Optimize performance by using atomic selectors instead of full store subscriptions
  // This prevents the component from re-rendering when unrelated state in the store changes.
